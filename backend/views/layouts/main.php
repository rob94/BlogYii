...
<div class="wrap">
    ...
    $menuItems[]=['label' => 'FACE', 'url' =>'https://es-la.facebook.com/'];
    $menuItems[]=['label' => 'Twitter', 'url' =>'https://www.twitter.com/'];
...
<footer class="footer">
    <div class="container">
        <p class="pull-left">&copy; ROB <!--cambio de nombre--><?=date('Y') ?></p>
